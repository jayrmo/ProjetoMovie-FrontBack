...
export function ManageMoviesPage() {
  ...
  // Carrega os dados iniciais (diretores, atores, gêneros)
  useEffect(() => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      addNotification(`Filme "${submitData.title}" criado com sucesso!`, 'success');
      navigate('/');
    } catch (err: any) {
      console.error('Erro ao criar filme:', err);
      const errorMsg = err.response?.data?.detail || 'Erro ao criar o filme';
      setError(errorMsg);
    ...
    <div className="bg-gray-900 min-h-screen w-full py-8">
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-red-600">Adicionar Filme</h1>
        </div>
